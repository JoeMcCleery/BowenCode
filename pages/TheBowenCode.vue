        ...
        <div class="uk-card uk-card-secondary uk-card-body">
          ...
          <div class="uk-card uk-card-primary uk-margin-auto uk-width-medium">
            <div class="uk-padding-small">
              ...
              <a uk-tooltip="Hole for bottle neck" class="uk-flex uk-flex-center uk-flex-middle uk-margin uk-height-small uk-width-small uk-margin-auto uk-background-secondary no-select" style="border-radius: 50%;"></a>
